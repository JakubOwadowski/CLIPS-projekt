...
class HorrorPicker implements ActionListener
  {  
   JLabel displayLabel;
   JButton nextButton;
   JButton prevButton;
   ...
   HorrorPicker()
     {  
      try
        {
         autoResources = ResourceBundle.getBundle("resources.Resources",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(autoResources.getString("HorrorPicker"));  
      jfrm.setMinimumSize(new Dimension(500, 500));
   ...
   public static void main(String args[])
     {  
      ...
      SwingUtilities.invokeLater(
        new Runnable() 
          {  
           public void run() { new HorrorPicker(); }  
          });   
     }  
  }